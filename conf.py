...
htmlhelp_basename = 'mini-hottdoc'
...
latex_elements = {
    ...
    'fontpkg': '\\usepackage{amsmath,amssymb,amsthm, amsfonts}',
    'figure_align':'htbp',
    # 'transition':'',
    'preamble': r'''
...
latex_documents = [
    ('README',
     'mini-hott.tex',
     u'mini-hott',
     u"Jonathan Prieto-Cubides", 'scrartcl'),
]
